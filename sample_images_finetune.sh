...
CUDA_VISIBLE_DEVICES=$1 accelerate launch \
          ...
          --save_path /data/healthy-ml/scratch/vinithms/projects/MACE-Update/experiments/${ALGO_NAME}_${LORA_WEIGHTS}_cele_${NUM_CELEBS} \
          ...
          --lora_path /data/healthy-ml/scratch/vinithms/projects/MACE-Update/finetuned_model/${ALGO_NAME}_${NUM_CELEBS}_celeb/pytorch_lora_weights.safetensors \
          --step 1
...
#           --prompts_path /data/healthy-ml/scratch/vinithms/projects/MACE-Update/prompts_csv/celebrity_${NUM_CELEBS}_concepts.csv \
#           --save_path /data/healthy-ml/scratch/vinithms/projects/MACE-Update/experiments/${ALGO_NAME}_${LORA_WEIGHTS}_cele_${NUM_CELEBS} \
#           --model_name /data/healthy-ml/scratch/vinithms/projects/MACE-Update/saved_model/LoRA_fusion_model/uce_10_celeb \
#           --lora_path /data/healthy-ml/scratch/vinithms/projects/MACE-Update/finetuned_model/uce_10_celeb/pytorch_lora_weights.safetensors \
#           --step 1